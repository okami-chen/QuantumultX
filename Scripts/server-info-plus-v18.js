let base_url = "http://ip234.in/fraud_check?ip="
...
function Display(resp) {
    ...
    let score = "</br><b>"+ "<font  color=>" +"欺诈 " + "</font> : " + "</b>"+ "<font  color=>"+ body.risk +"</font></br>"
    let risk = "</br><b>"+ "<font  color=>" +"风险 " + "</font> : " + "</b>"+ "<font  color=>"+ body.score +"</font></br>"
    return (score+risk)
}
